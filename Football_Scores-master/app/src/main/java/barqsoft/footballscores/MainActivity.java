...
{
    public static double selected_match_id; //Changed to double, because its stored as double in DB
    ...
    private void updateScores()   //I have moved this up to the activity, so it wont trigger for each fragment
    {
